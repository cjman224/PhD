function y = CalcSharpness(x, Fs)

Pref = 60; %reference value [dB]
Mod = 0;
...
sharp = 0.11 * sum(N_single.*gz.*z.*0.1) / sum(N_single.*0.1);

if(sum(N_single) == 0) sharp = 0; end
